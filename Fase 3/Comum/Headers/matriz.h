...
private:
	...
	friend Matrix<TE> operator*(const Matrix<TE> &a, const Matrix<TE> &b);
	template <typename TE>
	friend Matrix<TE> operator*(const TE &a, const Matrix<TE> &b);
	template <typename TE>
	friend Matrix<TE> operator*(const Matrix<TE> &a, const TE &b);
	template <typename TE>
	friend Matrix<TE> operator+(const Matrix<TE> &a, const Matrix<TE> &b);
	template <typename TE>
	friend Matrix<TE> operator-(const Matrix<TE> &a, const Matrix<TE> &b);
	template <typename TE>
	friend bool operator==(const Matrix<TE> &a, const Matrix<TE> &b);
	template <typename TE>
	friend std::ostream &operator<<(std::ostream &os, const Matrix<TE> &x);
	template <typename TE>
	friend std::istream &operator>>(std::istream &is, Matrix<TE> &x);
